...
import VerificarIdade from './comum/componentes/VerificarIdade/VerificarIdade';
import NumerosPares from './comum/componentes/NumerosPares/NumerosPares';
import NumerosImpares from './comum/componentes/NumerosImpares/NumerosImpares';
import Soma from './comum/componentes/Soma/Soma';
import Subtracao from './comum/componentes/Subtracao/Subtracao';
import Divisao from './comum/componentes/Divisao/Divisao';
import Multiplicacao from './comum/componentes/Multiplicacao/Multiplicacao';
import Calculadora from './comum/componentes/Calculadora/Calculadora';
...
function App() {
  return (
    <>
      ...
      <span>11.Crie um componente chamado 'NumerosPares' que aceita uma prop chamada 'numeros' e deve ser uma lista de números inteiros. O componente deve mostrar uma lista com os números pares em uma (ul) com o fundo azul e a letra amarela.
      </span>
      <NumerosPares />
      <hr />

      <span>12.Crie um componente chamado 'NumerosImpares' que aceita uma prop chamada 'numeros' e deve ser uma lista de números inteiros. O componente deve mostrar uma lista com os números ímpares em uma (ul) com o fundo azul e a letra amarela
      </span>
      <NumerosImpares />
      <hr />

      <span>13.Crie um componente chamado 'Soma' que aceita as props 'num1', 'num2', o componente deve mostrar: O resultado da soma entre os dois números em uma (div)com o fundo marrom, texto centralizado na cor branca.
      </span>
      <Soma num1={3} num2={3} />
      <hr />

      <span>14.Crie um componente chamado 'Subtracao' que aceita as props 'num1', 'num2', o componente deve mostrar: O resultado da subtração entre os dois números em uma (div) com o fundo cinza, texto centralizado na cor branca.
      </span>
      <Subtracao num1={10} num2={3} />
      <hr />

      <span>15. Crie um componente chamado 'Divisao' que aceita as props 'num1', 'num2', o componente deve mostrar: O resultado da divisão entre os dois números em uma (div) com o fundo laranja, texto centralizado na cor azul.
      </span>
      <Divisao num1={15} num2={3} />
      <hr />

      <span>16.Crie um componente chamado 'Multiplicacao' que aceita as props 'num1', 'num2', o componente deve mostrar: O resultado da multiplicação entre os dois números em uma (div) com o fundo laranja, texto centralizado na cor azul.
      </span>
      <Multiplicacao num1={4} num2={3} />
      <hr />

      <span>17.Crie um componente chamado 'Calculadora' que aceita as props 'num1', 'num2' e 'operacao'. A 'operacao' deve determinar que tipo de operação matemática que deve ser realizada (ex: soma, subtracao, multiplicacao, divisao). O componente deve mostrar: O resultado da operação entre os dois números em uma (div) com o fundo verde, texto centralizado na cor branca.
      </span>
      <Calculadora operacao={'*'} num1={10} num2={5} />
      <hr />
    </>
  );
}
